...
const initialStocks: Stock[] = [
  ...
  { symbol: "LSEG", name: "London Stock Exchange", price: 10245.0, change: 85.0, changePercent: 0.84, index: "LSE" },
  ...
  { symbol: "SBRY", name: "Sainsbury (J)", price: 267.5, change: 3.5, changePercent: 1.33, index: "LSE" },
